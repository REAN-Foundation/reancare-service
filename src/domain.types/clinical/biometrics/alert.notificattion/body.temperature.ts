...
export const bodyTemperatureNotificationTemplate: AlertNotification[] = [
    ...
    },
    {
        ...
        message : {
            "en-US" : "You have a fever! Your recent body temperature reading is {{BodyTemperature}}°F. If your temperature reaches ${TEMP_HIGH_THRESHOLD}°F or higher, seek medical attention immediately.",
            "es-ES" : "Tiene fiebre! Tu lectura de temperatura corporal es {{BodyTemperature}}°F. Si su temperatura llega a ${TEMP_HIGH_THRESHOLD}°F o superior, busque atención médica inmediatamente."
        }
    }
];

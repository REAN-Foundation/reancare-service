...
import { TenantFeatureSettingRepo } from './repositories/tenant/feature.setting/tenant.feature.setting.repo';
...
export class SequelizeInjector {
    ...
    static registerInjections(container: DependencyContainer) {
        ...
        container.register('ITenantFeatureSettingRepo',TenantFeatureSettingRepo);
    }

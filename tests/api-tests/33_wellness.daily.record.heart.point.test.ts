...
describe('Heart points records tests', function() {

    var agent = request.agent(infra._app);

    it('153 - Create heart points', function(done) {
    ...
    it('154 - Get heart points by id', function(done) {

        agent
            .get(`/api/v1/wellness/daily-records/heart-points/${getTestData('HeartPointId')}`)
            .set('Content-Type', 'application/json')
            .set('x-api-key', 'T26BP24-MRGMRYE-JB90S0V-NC93PY0')
            .set('Authorization', `Bearer ${getTestData("PatientJwt")}`)
            .expect(response => {
    ...
    it('155 - Search heart points records', function(done) {
    ...
    it('156 - Update heart points', function(done) {
    ...
    it('157 - Delete heart points', function(done) {
       
        agent
            .delete(`/api/v1/wellness/daily-records/heart-points/${getTestData('HeartPointId')}`)
            .set('Content-Type', 'application/json')
            .set('x-api-key', 'T26BP24-MRGMRYE-JB90S0V-NC93PY0')
            .set('Authorization', `Bearer ${getTestData("PatientJwt")}`)
            .expect(response => {
...
function loadHeartPointQueryString() {
    ...
    const queryString = '?heartPoints=8';
    return queryString;
}

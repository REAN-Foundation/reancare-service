...
import { IMedicalConditionRepo } from "../../database/repository.interfaces/static types/medical.condition.repo.interface";
...
import { MedicalConditionSearchResults, MedicalConditionSearchFilters } from '../../domain.types/static.types/medical.condition/medical.condition.search.types';

...
describe('48 - Medication tests', function() {
    ...
    it('48 - 01 - Negative - Get a list of drugs from database', function(done) {
        loadDrugQueryString();
        agent
            .get(`/api/v1/clinical/drugs/search${loadDrugQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('48 - 02 - Negative - Get a list of medication-duration-units', function(done) {
        agent
            .get(`/api/v1/clinical/medications/duration-units/`)
            .set('Content-Type', 'application/json')
            .expect(response => {
    ...
    it('48 - 03 - Negative - Get a list of medication-frequency units', function(done) {
        agent
            .get(`/api/v1/clinical/medications/frequency-units/`)
            .set('Content-Type', 'application/json')
            .set('Authorization', `Bearer ${getTestData("PatientJwt")}`)
    ...
    it('48 - 04 - Negative - Get medication stock image by id', function(done) {
        agent
    ...
    it('48 - 05 - Negative - Add new medication by drug name', function(done) {
        loadMedicationCreateModel();
        const createModel = getTestData("MedicationCreateModel");
        agent
            .post(`/api/v1/clinical/medications/`)
    ...
    it('48 - 06 - Negative - Add new medication by drug id', function(done) {
        loadMedicationDrugIdCreateModel();
        const createModel = getTestData("MedicationDrugIdCreateModel");
        agent
            .post(`/api/v1/clinical/medications/`)
    ...
    it('48 - 07 - Negative - Get current patient medications', function(done) {
        agent
            .get(`/api/v1/clinical/medications/current/${getTestData('PatientUserId')}`)
            .set('Content-Type', 'application/json')
            .set('Authorization', `Bearer ${getTestData("PatientJwt")}`)
    ...
    it('48 - 08 - Negative - Get medication by id', function(done) {
    ...
    it('48 - 09 - Negative - Delete Medication', function(done) {

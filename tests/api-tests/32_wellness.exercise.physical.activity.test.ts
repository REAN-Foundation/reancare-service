...
describe('32 - Physical activity tests', function() {
    ...
    it('32 - 01 - Negative - Create physical activity', function(done) {
        loadPhysicalActivityCreateModel();
    ...
    it('32 - 02 - Negative - Search physical activity records', function(done) {
        loadPhysicalActivityQueryString();
        agent
            .get(`/api/v1/wellness/exercise/physical-activities/search${loadPhysicalActivityQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('32 - 03 - Negative - Delete physical activity', function(done) {
...
const Category = getRandomEnumValue(PhysicalActivityCategories);


const intensity = getRandomEnumValue(Intensity);

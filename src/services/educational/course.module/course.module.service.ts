...
import { ICourseModuleRepo } from "../../../database/repository.interfaces/educational/course.module/course.module.repo.interface";
import { CourseModuleDomainModel } from '../../../domain.types/educational/course.module/course.module.domain.model';
...
import { CourseModuleSearchFilters,
    ...
    } from '../../../domain.types/educational/course.module/course.module.search.types';

    ...
    public connect = async (): Promise<boolean> => {
        ...
        try {
            ...
            const modelsPath = [
                ...
                __dirname + '/models/educational/course',
                __dirname + '/models/educational/course.module',
                __dirname + '/models/educational/course.content',
                __dirname + '/models/educational/user.course.enrollment',
                __dirname + '/models/educational/user.course.module',
                __dirname + '/models/educational/user.course.content',

...
describe('60 - Blood oxygen saturation tests', function() {
    ...
    it('60 - 01 - Negative - Create blood oxygen saturation', function(done) {
    ...
    it('60 - 02 - Negative - Get blood oxygen saturation by id', function(done) {
    ...
    it('60 - 03 - Negative - Update blood oxygen saturation', function(done) {
        loadBloodOxygenSaturationUpdateModel();
        const updateModel = getTestData("BloodOxygenSaturationUpdateModel");
        agent

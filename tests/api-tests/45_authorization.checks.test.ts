...
describe('45 - Authorization checks tests', function() {
    ...
    it('45 - 02 - Create patient with phone & password', function(done) {
        const PatientPasswordPhoneCreateModelAuth = getTestData("PatientPasswordPhoneCreateModelAuth");
        agent
            .post(`/api/v1/patients/`)
            .set('Content-Type', 'application/json')
            .set('x-api-key', `${process.env.TEST_API_KEY}`)
            .send(PatientPasswordPhoneCreateModelAuth)
            .expect(response => {
    ...
    it('45 - 01 - Negative - Second patient tries to get blood pressure of first', function(done) {
    ...
    it('45 - 02 - Negative - Second patient tries to update blood pressure of first', function(done) {
        loadBloodPressureUpdateModel();
        const updateModel = getTestData("BloodPressureUpdateModel");
        agent
            .put(`/api/v1/clinical/biometrics/blood-pressures/${getTestData('BloodPressureId')}`)
    ...
    it('45 - 03 - Negative - Second patient tries to delete blood pressure of first', function(done) {

...
describe('Person address tests', function() {

    var agent = request.agent(infra._app);

    it('57 - Add address to person', function(done) {
    ...
    it('58 - Get address for person after addition', function(done) {
        agent
    ...
    it('59 - Removal an address from person', function(done) {
    ...
    it('60 - Get address for person after removal', function(done) {
        agent
            .get(`/api/v1/persons/${getTestData('PatientPersonId')}/addresses`)
            .set('Content-Type', 'application/json')
            .set('x-api-key', 'T26BP24-MRGMRYE-JB90S0V-NC93PY0')

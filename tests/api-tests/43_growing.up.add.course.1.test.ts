...
describe('Add course - Manav Vikas Ki Avasthaein tests', function() {

    var agent = request.agent(infra._app);

    it('201 - upload image', function(done) {
        agent
    ...
    it('202 - Add course', function(done) {
    ...
    it('203 - Add module', function(done) {
    ...
    it('204 - Add content', function(done) {

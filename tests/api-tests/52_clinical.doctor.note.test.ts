...
describe('52 - Doctor note tests', function() {
    ...
    it('52 - 01 - Negative - Create doctor note', function(done) {
    ...
    it('52 - 02 - Negative - Search doctor note records', function(done) {
        loadDoctorNoteQueryString();
        agent
            .get(`/api/v1/clinical/doctor-notes/search/${getTestData("PatientUserId")}${loadDoctorNoteQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('52 - 03 - Negative - Delete doctor note', function(done) {

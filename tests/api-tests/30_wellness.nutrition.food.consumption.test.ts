...
describe('30 - Nutrition food consumption tests', function() {
    ...
    it('30 - 01 - Negative - Create food consumption', function(done) {
        loadFoodCreateModel();
        const createModel = getTestData("FoodCreateModel");
        agent
            .post(`/api/v1/wellness/nutrition/food-consumptions/`)
    ...
    it('30 - 02 - Negative - Get food consumption by event name', function(done) {
    ...
    it('30 - 03 - Negative - Search food consumption records', function(done) {
        loadFoodQueryString();
        agent
            .get(`/api/v1/wellness/nutrition/food-consumptions/search${loadFoodQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('30 - 04 - Negative - Delete food consumption', function(done) {
...
const consumedAs = getRandomEnumValue(FoodConsumptionEvents);

...
export const register = (app: express.Application): void => {
    ...
    router.get('/:patientUserId', auth('User.Patient.HealthProfile.GetByPatientUserId'), controller.getByPatientUserId);
    router.put('/:patientUserId', auth('User.Patient.HealthProfile.UpdateByPatientUserId'), controller.updateByPatientUserId);

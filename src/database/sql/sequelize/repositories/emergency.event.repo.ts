import { IEmergencyEventRepo } from '../../../repository.interfaces/emergency.event.repo.interface';
import EmergencyEvent from '../models/emergency.event.model';
import { Op } from 'sequelize';
import { EmergencyEventMapper } from '../mappers/emergency.event.mapper';
import { Logger } from '../../../../common/logger';
import { ApiError } from '../../../../common/api.error';
import { EmergencyEventDomainModel } from '../../../../domain.types/emergency.event/emergency.event.domain.model';
import { EmergencyEventDto } from '../../../../domain.types/emergency.event/emergency.event.dto';
import { EmergencyEventSearchFilters, EmergencyEventSearchResults } from '../../../../domain.types/emergency.event/emergency.event.search.types';

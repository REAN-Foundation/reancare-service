...
describe('31 - Meditation tests', function() {
    ...
    it('31 - 01 - Negative - Create meditation', function(done) {
        loadMeditationCreateModel();
    ...
    it('31 - 02 - Negative - Get meditation by id', function(done) {
    ...
    it('31 - 03 - Negative - Update meditation', function(done) {
        loadMeditationUpdateModel();
        const updateModel = getTestData("MeditationUpdateModel");
        agent

...
import { IEmergencyEventRepo } from "../database/repository.interfaces/emergency.event.repo.interface";
...
import { EmergencyEventSearchResults, EmergencyEventSearchFilters } from '../domain.types/emergency.event/emergency.event.search.types';

...
describe('38 - Knowledge nuggets tests', function() {
    ...
    it('38 - 01 - Negative - Create knowledge nugget', function(done) {
        loadKnowledgeNuggetCreateModel();
    ...
    it('38 - 02 - Negative - Get knowledge nugget by id', function(done) {
    ...
    it('38 - 03 - Negative - Update knowledge nugget', function(done) {
        loadKnowledgeNuggetUpdateModel();
        const updateModel = getTestData("KnowledgeNuggetUpdateModel");
        agent
    ...
    it('38 - 04 - Negative - Delete knowledge nugget', function(done) {

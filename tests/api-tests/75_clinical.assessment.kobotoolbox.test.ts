...
describe('75 - KoboToolbox integration tests', function() {
    ...
    it('75 - 01 - Negative - Connect to kobo-toolbox api', function(done) {
    ...
    it('75 - 02 - Negative - Get forms list', function(done) {
    ...
    it('75 - 03 - Negative - Schedule assessment with generated template', function(done) {
        loadAssessmentModel();
        const createModel = getTestData("AssessmentCreateModel");
        agent
            .post(`/api/v1/clinical/assessments`)

...
describe('71 - Health priority tests', function() {
    ...
    it('71 - 01 - Negative - Get patient goals', function(done) {
    ...
    it('71 - 02 - Negative - Create goal', function(done) {
    ...
    it('71 - 03 - Negative - Get goal by id', function(done) {
    ...
    it('71 - 04 - Negative - Delete goal', function(done) {

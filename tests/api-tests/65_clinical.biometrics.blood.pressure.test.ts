...
describe('65 - Blood pressure tests', function() {
    ...
    it('65 - 01 - Negative - Create blood pressure', function(done) {
    ...
    it('65 - 02 - Negative - Search blood pressure records', function(done) {
        loadBloodPressureQueryString();
        agent
            .get(`/api/v1/clinical/biometrics/blood-pressures/search${loadBloodPressureQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('65 - 03 - Negative - Delete blood pressure', function(done) {

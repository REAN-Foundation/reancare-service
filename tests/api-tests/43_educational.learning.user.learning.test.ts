...
describe('42 - User learning tests', function() {

    var agent = request.agent(infra._app);

    it('42 - 01 - Get User Learning Paths', function(done) {
        agent
    ...
    it('42 - 02 - Get User Course Contents', function(done) {
        agent
    ...
    it('42 - 03 - Get Learning Path Progress', function(done) {
        agent
    ...
    it('42 - 04 - Get Course Progress', function(done) {
        agent
    ...
    it('42 - 05 - Get Module Progress', function(done) {
        agent
    ...
    it('42 - 06 - Get Content Progress', function(done) {
        agent
    ...
    it('42 - 07 - Update User Learning', function(done) {
...
const progressStatus = getRandomEnumValue(ProgressStatus);

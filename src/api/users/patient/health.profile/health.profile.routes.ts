...
export const register = (app: express.Application): void => {
    ...
    router.get('/:patientUserId', authenticator.authenticateUser, controller.getByPatientUserId);
    router.put('/:patientUserId', authenticator.authenticateUser, controller.updateByPatientUserId);

...
describe('78 - Run Kobo Form assessment', function() {
    ...
    it('78 - 01 - Negative - Start assessment', function(done) {
    ...
    it('78 - 02 - Negative - Get next assessment question', function(done) {
    ...
    it('78 - 03 - Negative - Get assessment question by id', function(done) {
    ...
    it('78 - 05 - Negative - Answer sixth question - Message', function(done) {
        loadCustomAssessmentNodeMessageTypeModel();

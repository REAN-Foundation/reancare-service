...
describe('55 - Symptom assessment tests', function() {
    ...
    it('55 - 01 - Negative - Create assessment', function(done) {
    ...
    it('55 - 02 - Negative - Get assessment by id', function(done) {
    ...
    it('55 - 03 - Negative - Update assessment', function(done) {
        loadAssessmentUpdateModel();
        const updateModel = getTestData("AssessmentUpdateModel");
        agent

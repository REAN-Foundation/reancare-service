...
describe('98 - Medical condition tests', function () {
    ...
    it('98:01 -> Create medical condition', function (done) {
        ...
        agent
            ...
            .send(createModel)
            .expect((response) => {
                setTestData(response.body.Data.MedicalCondition.id, 'MedicalConditionId_1');
                ...
                expect(response.body.Data.MedicalCondition.Description).to.equal(
                    getTestData('MedicalConditionCreateModel').Description
                );
    ...
    it('98:04 -> Update medical condition', function (done) {
        ...
        agent
            ...
            .expect((response) => {
                ...
                expect(response.body.Data.MedicalCondition.Condition).to.equal(getTestData('MedicalConditionUpdateModel').Condition);
                expect(response.body.Data.MedicalCondition.Description).to.equal(
                    getTestData('MedicalConditionUpdateModel').Description
                );
                expect(response.body.Data.MedicalCondition.Language).to.equal(getTestData('MedicalConditionUpdateModel').Language);
            })
            .expect(200, done);
    });
    ...
    it('Create medical condition again', function (done) {
        ...
        agent
            ...
            .send(createModel)
            .expect((response) => {
                setTestData(response.body.Data.MedicalCondition.id, 'MedicalConditionId');
                expect(response.body.Data.MedicalCondition).to.have.property('Condition');
                expect(response.body.Data.MedicalCondition).to.have.property('Description');
                expect(response.body.Data.MedicalCondition).to.have.property('Language');

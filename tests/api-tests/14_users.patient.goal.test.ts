...
describe('14 - Patient goal tests', function() {
    ...
    it('14 - 01 - Negative - Create patient goal', function(done) {
    ...
    it('14 - 02 - Negative - Update patient goal', function(done) {
        loadPatientGoalUpdateModel();
        const updateModel = getTestData("PatientGoalUpdateModel");
        agent
    ...
    it('14 - 03 - Negative - Delete patient goal', function(done) {

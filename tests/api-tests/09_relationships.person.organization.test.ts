...
describe('09 - Person-Organization tests', function() {
    ...
    it('09 - 01 - Negative - Create person-organization', function(done) {
    ...
    it('09 - 02 - Negative - Get organization by Personid', function(done) {
        agent
            .get(`/api/v1/persons/${getTestData('DoctorPersonId')}/organizations`)
            .set('Content-Type', 'application/json')
            .set('x-api-key', `${process.env.TEST_API_KEY}`)
    ...
    it('09 - 03 - Negative - Get Person for Organization', function(done) {
        agent
            .get(`/api/v1/organizations/${getTestData('OrganizationId')}/persons`)
            .set('Content-Type', 'application/json')
            .set('Authorization', `Bearer ${getTestData("DoctorJwt")}`)
    ...
    it('09 - 04 - Negative - Removal person from organization', function(done) {

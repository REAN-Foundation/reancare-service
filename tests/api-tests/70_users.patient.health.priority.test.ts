...
describe('70 - Health priority tests', function() {
    ...
    it('70 - 01 - Negative - Create health priority', function(done) {
    ...
    it('70 - 02 - Negative - Search health priority records', function(done) {
        loadPriorityQueryString();
        agent
            .get(`/api/v1/patient-health-priorities/search${loadPriorityQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('70 - 03 - Negative - Delete health priority', function(done) {
...
export const loadPriorityCreateModel = async (
    ...
    const model = {
        ...
        Provider             : Provider,
        Source               : Source,
        ProviderEnrollmentId : providerEnrollmentId,
        ProviderCareplanCode : providerCareplanCode,
        ProviderCareplanName : providerCareplanName,
...
const healthPriorityType = getRandomEnumValue(HealthPriorityType);

...
export interface IActivityTrackerRepo {

    create(activityTrackerDomainModel: ActivityTrackerDomainModel): Promise<ActivityTrackerDto>;

    getById(id: string): Promise<ActivityTrackerDto>;

    search(filters: ActivityTrackerSearchFilters): Promise<ActivityTrackerSearchResults>;

    update(id: string, activityTrackerDomainModel: ActivityTrackerDomainModel): Promise<ActivityTrackerDto>;

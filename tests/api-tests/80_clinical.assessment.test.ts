...
describe('80 - CURD Model tests', function() {
    ...
    it('80 - 01 - Negative - Get assessment template by id', function(done) {
    ...
    it('80 - 02 - Negative - Update assessment template by id', function(done) {
        loadAssessmentTemplateUpdateModel();
        const updateModel = getTestData("AssessmentTemplateUpdateModel");
    ...
    it('80 - 03 - Negative - Search assessment templates', function(done) {
        loadAssessmentTemplateQueryString();
        agent
            .get(`/api/v1/clinical/assessment-templates/search${loadAssessmentTemplateQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('80 - 04 - Negative - Delete assessment template by id', function(done) {

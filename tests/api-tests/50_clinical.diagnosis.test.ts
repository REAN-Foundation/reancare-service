...
describe('50 - Diagnosis tests', function() {
    ...
    it('50 - 01 - Negative - Create diagnosis', function(done) {
        loadDiagnosisCreateModel();
        const createModel = getTestData("DiagnosisCreateModel");
        agent
            .post(`/api/v1/clinical/diagnoses/`)
    ...
    it('50 - 02 - Negative - Search diagnosis records', function(done) {
        loadDiagnosisQueryString();
        agent
            .get(`/api/v1/clinical/diagnoses/search${loadDiagnosisQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('50 - 03 - Negative - Delete diagnosis', function(done) {
...
export const loadDiagnosisCreateModel = async (
    ...
    const model = {
        ...
        Comments                  : Comments,
        IsClinicallyActive        : isClinicallyActive,
...
const clinicalValidationStatus = getRandomEnumValue(ClinicalValidationStatus);

const clinicalInterpretation = getRandomEnumValue(ClinicalInterpretation);

...
describe('63 - Body temperature tests', function() {
    ...
    it('63 - 01 - Negative - Create body temperature', function(done) {
    ...
    it('63 - 02 - Negative - Search body temperature records', function(done) {
        loadBodyTemperatureQueryString();
        agent
            .get(`/api/v1/clinical/biometrics/body-temperatures/search${loadBodyTemperatureQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('63 - 03 - Negative - Delete body temperature', function(done) {

...
describe('88 - Third user logs in tests', function() {
    ...
    it('88 - 01 - Negative - Search patient records', function(done) {
        loadPatientQueryString();
        agent
            .get(`/api/v1/patients/search${loadPatientQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('88 - 02 - Negative - Start conversation', function(done) {
    ...
    it('88 - 03 - Negative -  First user sends message', function(done) {
        loadFirstUserConversationModel();
        const createModel = getTestData("FirstUserConversationModel");
        agent
            .post(`/api/v1/chats/conversations/${getTestData('ConversationId')}/messages`)
    ...
    it('88 - 04 - Negative - Second user sends message', function(done) {
        loadSecondUserConversationModel();
        const createModel = getTestData("SecondUserConversationModel");
        agent
            .post(`/api/v1/chats/conversations/${getTestData('ConversationId')}/messages`)
    ...
    it('88 - 05 - Negative - First user sends message', function(done) {
        loadFirstUserMessageModel();
        const createModel = getTestData("FirstUserMessageModel");
        agent
            .post(`/api/v1/chats/conversations/${getTestData("ConversationId")}/messages`)
    ...
    it('88 - 06 - Negative - Second user sends message', function(done) {
        loadSecondUserMessageModel();
        const createModel = getTestData("SecondUserMessageModel");
        agent
            .post(`/api/v1/chats/conversations/${getTestData("ConversationId")}/messages`)
    ...
    it('88 - 07 - Negative - Get conversation between these two users - 1', function(done) {
    ...
    it('88 - 08 - Negative - Get conversation messages', function(done) {
    ...
    it('88 - 09 - Negative - Get conversation by id', function(done) {
    ...
    it('88 - 10 - Negative - Get message by id', function(done) {
    ...
    it('88 - 11 - Negative - Update message by id', function(done) {
    ...
    it('88 - 12 - Negative - Delete message by id', function(done) {
    ...
    it('88 - 13 - Negative - Get recent conversations for first user', function(done) {
    ...
    it('88 - 14 - Negative - Get marked/favourite conversations for first user', function(done) {

...
export class EHRSymptomService {
    ...
    constructor(
        ...
        this._howDoYouFeelService = Injector.Container.resolve(HowDoYouFeelService);
        this._dailyAssessmentService = Injector.Container.resolve(DailyAssessmentService);
    }

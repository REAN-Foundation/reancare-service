...
import { IPulseRepo } from "../../database/repository.interfaces/biometrics/pulse.repo.interface ";
...
import { PulseSearchResults, PulseSearchFilters } from '../../domain.types/biometrics/pulse/pulse.search.types';

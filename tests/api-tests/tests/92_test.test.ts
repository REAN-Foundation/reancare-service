...
describe('92 - tests', function() {

    var agent = request.agent(infra._app);
   
    it('92:01 -> Create knowledge nugget test', function(done) {
  ...
  it('92:02 -> Create heart points test', function(done) {
  ...
  it('92:03 -> Get patient health profile test', function(done) {
    agent
  ...
  it('92:04 -> Update health profile', function(done) {
  ...
  it('92:05 -> Create address', function(done) {

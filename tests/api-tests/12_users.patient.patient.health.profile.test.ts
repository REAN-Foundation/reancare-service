...
describe('12 - Patient health profile tests', function() {
    ...
    it('12 - 01 - Negative - Get severity list', function(done) {
        agent
            .get(`/api/v1/types/severities/`)
            .set('Content-Type', 'application/json')
    ...
    it('12 - 02 - Negative - Get blood groups', function(done) {
        agent
            .get(`/api/v1/types/blood-groups/`)
            .set('Content-Type', 'application/json')
            .expect(response => {
...
export const loadHealthProfileUpdateModel = async (
    ...
    const model = {
        ...
        HasHeartAilment    : hasHeartAilment,
        ...
        IsSmoker           : isSmoker,
        IsDrinker          : isDrinker,
        DrinkingSeverity   : drinkingSeverity,
        DrinkingSince      : drinkingSince,
...
const bloodGroup = getRandomEnumValue(BloodGroupList);

const maritalStatus = getRandomEnumValue(MaritalStatusList);

const drinkingSeverity = getRandomEnumValue(Severity);

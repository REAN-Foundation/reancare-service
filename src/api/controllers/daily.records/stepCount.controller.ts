...
import { StepCountValidator } from '../../validators/daily.records/stepCount.validator';
import { StepCountService } from '../../../services/daily.records/stepCount.service';
...
export class StepCountController {
    ...
    search = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            ResponseHandler.success(request, response, message, 200, { StepCount: searchResults });

...
describe('77 - Assessment tests', function() {
    ...
    it('77 - 01 - Negative - Create assessment', function(done) {
    ...
    it('77 - 02 - Negative - Get assessment by id', function(done) {
    ...
    it('77 - 03 - Negative - Update assessment', function(done) {
        loadAssessmentUpdateModel();
        const updateModel = getTestData("AssessmentUpdateModel");
        agent
    ...
    it('77 - 04 - Negative - Delete assessment', function(done) {

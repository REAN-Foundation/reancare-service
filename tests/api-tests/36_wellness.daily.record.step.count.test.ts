...
describe('36 - Step counts records tests', function() {
    ...
    it('36 - 01 - Negative - Create step counts', function(done) {
        loadStepCountCreateModel();
    ...
    it('36 - 02 - Negative - Get step counts by id', function(done) {
    ...
    it('36 - 03 - Negative - Update step counts', function(done) {
        loadStepCountUpdateModel();
        const updateModel = getTestData("StepCountUpdateModel");
        agent

...
describe('44 - File resource management tests', function() {
    ...
    it('44 - 02 - Negative - Upload file as public resource', function(done) {
        agent
            .post(`/api/v1/file-resources/upload/`)
            .set('Content-Type', 'application/json')
            .set('x-api-key', `${process.env.TEST_API_KEY}`)
    ...
    it('44 - 03 - Negative - Upload multi-resolution image', function(done) {
        agent
            .post(`/api/v1/file-resources/upload/`)
            .set('Content-Type', 'application/json')
            .set('x-api-key', `${process.env.TEST_API_KEY}`)
    ...
    it('44 - 04 - Negative - Upload file version', function(done) {
        agent
            .post(`/api/v1/file-resources/${getTestData("FileId")}/upload-version/`)
            .set('Content-Type', 'application/json')
            .set('x-api-key', `${process.env.TEST_API_KEY}`)
    ...
    it('44 - 05 - Negative - Rename file', function(done) {
        agent
    ...
    it('44 - 06 - Negative - Get resource by id', function(done) {
        agent
            .get(`/api/v1/file-resources/${getTestData("FileId")}`)
            .set('Content-Type', 'application/json')
            .set('Authorization', `Bearer ${getTestData("PatientJwt")}`)
    ...
    it('44 - 07 - Negative - Get versions', function(done) {
        agent

...
describe('33 - Heart points records tests', function() {
    ...
    it('33 - 01 - Negative - Create heart points', function(done) {
        loadHeartPointCreateModel();
    ...
    it('33 - 02 - Negative - Get heart points by id', function(done) {
    ...
    it('33 - 03 - Negative - Update heart points', function(done) {
        loadHeartPointUpdateModel();
        const updateModel = getTestData("HeartPointUpdateModel");
        agent

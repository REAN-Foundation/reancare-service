...
describe('06 - Organization tests', function() {
    ...
    it('06 - 01 - Negative - Create organization', function(done) {
    ...
    it('06 - 02 - Negative - Search organization records', function(done) {
        loadOrganizationQueryString();
        agent
            .get(`/api/v1/organizations/search${loadOrganizationQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('06 - 03 - Negative - Delete organization', function(done) {
...
const Type = getRandomEnumValue(OrganizationTypes);

...
describe('90 - tests', function() {

    var agent = request.agent(infra._app);
   
    it('90:01 -> Create assessment template test', function(done) {
...
it('90:02 -> Create assessment', function(done) {
...
it('90:03 -> Create blood oxygen saturation test', function(done) {
...
it('90:04 -> Create body weight', function(done) {
...
it('90:05 -> Create blood glucose', function(done) {

...
describe('61 - Body height tests', function() {
    ...
    it('61 - 01 - Negative - Create body height', function(done) {
    ...
    it('61 - 02 - Negative - Search body height records', function(done) {
        loadBodyHeightQueryString();
        agent
            .get(`/api/v1/clinical/biometrics/body-heights/search${loadBodyHeightQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('61 - 03 - Negative - Delete body height', function(done) {

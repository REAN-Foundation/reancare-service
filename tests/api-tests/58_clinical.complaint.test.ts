...
describe('58 - Complaint tests', function() {
    ...
    it('58 - 01 - Negative - Create complaint', function(done) {
    ...
    it('58 - 02 - Negative - Search complaint records', function(done) {
        loadComplaintQueryString();
        agent
            .get(`/api/v1/clinical/complaints/search/${getTestData("PatientUserId")}`)
            .set('Content-Type', 'application/json')
    ...
    it('58 - 03 - Negative - Delete complaint', function(done) {
...
const severityList = getRandomEnumValue(Severity);

...
describe('69 - Assessment tasks tests', function() {
    ...
    it('69 - 01 - Negative - Search careplan tasks', function(done) {
        loadAssessmentQueryString();
        agent
            .get(`/api/v1/user-tasks/search${loadAssessmentQueryString()}`)
            .set('Content-Type', 'application/json')
    ...
    it('69 - 02 - Negative - Get task by id', function(done) {
    ...
    it('69 - 03 - Negative Get assessment by id', function(done) {
    ...
    it('69 - 04 - Negative - Start assessment', function(done) {
        agent
            .post(`/api/v1/clinical/assessments/${getTestData('AssessmentId')}/start`)
            .set('Content-Type', 'application/json')
            .set('x-api-key', `${process.env.TEST_API_KEY}`)

...
describe('67 - Daily assessment tests', function() {
    ...
    it('67 - 01 - Negative - Create daily assessment', function(done) {
    ...
    it('67 - 02 - Negative - Search daily assessment records', function(done) {
        loadDailyAssessmentQueryString();
        agent
            .get(`/api/v1/clinical/daily-assessments/search${loadDailyAssessmentQueryString()}`)
            .set('Content-Type', 'application/json')
...
const dailyAssessmentFeelings = getRandomEnumValue(DailyAssessmentFeelings);

const dailyAssessmentMoods = getRandomEnumValue(DailyAssessmentMoods);

const dailyAssessmentEnergyLevels = getRandomEnumValue(DailyAssessmentEnergyLevels);

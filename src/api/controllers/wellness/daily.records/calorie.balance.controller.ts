...
export class CalorieBalanceController extends BaseController{
    ...
    create = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            this.setContext('CalorieBalance.Create', request, response);
    ...
    getById = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            this.setContext('CalorieBalance.GetById', request, response);
    ...
    search = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            this.setContext('CalorieBalance.Search', request, response);
    ...
    update = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            this.setContext('CalorieBalance.Update', request, response);
    ...
    delete = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            this.setContext('CalorieBalance.Delete', request, response);

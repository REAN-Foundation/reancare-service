...
describe('29 - Nutrition water consumption tests', function() {
    ...
    it('29 - 01 - Negative - Create water consumption', function(done) {
        loadWaterCreateModel();
    ...
    it('29 - 02 - Negative - Get water consumption by id', function(done) {
    ...
    it('29 - 03 - Negative - Update water consumption', function(done) {
        loadWaterUpdateModel();
        const updateModel = getTestData("WaterUpdateModel");
        agent

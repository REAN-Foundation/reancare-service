...
describe('76 - Custom Assessment - Add nodes', function() {
    ...
    it('76 - 01 - Negative - Create an assessment template', function(done) {
    ...
    it('76 - 02 - Negative - Add question node - single choice', function(done) {
        loadCustomAssessmentSCQModel();
    ...
    it('76 - 03 - Negative - Add list node', function(done) {
        loadCustomAssessmentNodeListModel();
    ...
    it('76 - 04 - Negative - Add question node - date', function(done) {
        loadCustomAssessmentNodeDateTypeModel();
    ...
    it('76 - 05 - Negative - Add message node', function(done) {
        loadCustomAssessmentNodeMessageTypeModel();
    ...
    it('76 - 06 - Negative - Get updated assessment template by id', function(done) {
    ...
    it('76 - 07 - Negative - Get node by id', function(done) {
...
export const loadCustomAssessmentCreateModel = async (
    ...
    const model = {
        ...
        Type                   : assessmentType,
        Provider               : Provider,
        ProviderAssessmentCode : providerCareplanCode
    };
...
export const loadNegativeCustomAssessmentCreateModel = async (  
    ...
    const model = {
        Provider               : Provider,
        ProviderAssessmentCode : providerGivenCode
    };
    setTestData(model, "NegativeCustomAssessmentCreateModel");
};

const assessmentType = getRandomEnumValue(AssessmentType);

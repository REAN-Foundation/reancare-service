...
describe('66 - Blood glucose tests', function() {
    ...
    it('66 - 01 - Negative - Create blood glucose', function(done) {
    ...
    it('66 - 02 - Negative - Get blood glucose by id', function(done) {
    ...
    it('66 - 03 - Negative - Update blood glucose', function(done) {
        loadBloodGlucoseUpdateModel();
        const updateModel = getTestData("BloodGlucoseUpdateModel");
        agent

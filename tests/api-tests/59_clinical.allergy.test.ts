...
describe('59 - Allergy tests', function() {
    ...
    it('59 - 01 - Negative - Get allergen categories', function(done) {
    ...
    it('59 - 02 - Negative - Create patient allergy', function(done) {
    ...
    it('59 - 03 - Negative - Get patient allergy by id', function(done) {
    ...
    it('59 - 04 - Negative - Update patient allergy', function(done) {
        loadAllergyUpdateModel();
        const updateModel = getTestData("AllergyUpdateModel");
        agent
    ...
    it('59 - 05 - Negative - Delete patient allergy', function(done) {
...
const allergenCategories = getRandomEnumValue(AllergenCategories);

const allergenExposureRoutes = getRandomEnumValue(AllergenExposureRoutes);

const severity = getRandomEnumValue(Severity);

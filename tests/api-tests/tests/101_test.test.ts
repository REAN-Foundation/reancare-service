...
describe('101 - tests', function() {

    var agent = request.agent(infra._app);
   
    it('101:01 -> Create assessment template test', function(done) {
...
it('101:02 -> Create assessment', function(done) {
...
it('101:03 -> Create blood oxygen saturation test', function(done) {
...
it('101:04 -> Create body weight', function(done) {
...
it('101:05 -> Create blood glucose', function(done) {
...
export const loadBloodGlucoseCreateModel = async (
      ...
      const model = {
        PatientUserId    : getTestData('PatientUserId'),
        Unit             : "mg|dL",
        BloodGlucose     : faker.number.int({ min:101, max: 105 }),

...
describe('10 - Organization-address tests', function() {
    ...
    it('10 - 01 - Negative - Create organization address', function(done) {
        agent
            .post(`/api/v1/organizations/${getTestData('OrganizationId')}/add-address/${getTestData('AddressId')}`)
            .set('Content-Type', 'application/json')
    ...
    it('10 - 02 - Negative - Get address by organization id', function(done) {
        agent
            .get(`/api/v1/organizations/${getTestData('OrganizationId')}/addresses`)
            .set('Content-Type', 'application/json')
            .set('Authorization', `Bearer ${getTestData("PatientJwt")}`)
    ...
    it('10 - 03 - Negative - Removal an address from organization', function(done) {

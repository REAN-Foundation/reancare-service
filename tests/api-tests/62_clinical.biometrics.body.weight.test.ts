...
describe('62 - Body weight tests', function() {
    ...
    it('62 - 01 - Negative - Create body weight', function(done) {
    ...
    it('62 - 02 - Negative - Get body weight by id', function(done) {
    ...
    it('62 - 03 - Negative - Update body weight', function(done) {
        loadBodyWeightUpdateModel();
        const updateModel = getTestData("BodyWeightUpdateModel");
        agent
